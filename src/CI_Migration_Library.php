...
class CI_Migration_Library
{
    ...
    {
        // 從 db 取得 migrations 資訊
        $db_migrations = [];
        $query = $this->db->query("SELECT * FROM {$this->_migration_table} ORDER BY version ASC");
    ...
    {
        $migrations = $this->db->get($this->_migration_table)->order_by('id', 'asc')->result_array();
        return $migrations;
    }
     ...
     * @return	void
     */
    public function update_version($migration, $method = "up")
    {
